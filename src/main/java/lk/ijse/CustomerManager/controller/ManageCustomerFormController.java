...
public class ManageCustomerFormController {
    ...
    void btnDeleteOnAction(ActionEvent event) {
        ...
        Customer customer = customerModel.searchCustomer(Integer.parseInt(customerTel));
        if(customer == null){
    ...
    void btnUpdateOnAction(ActionEvent event) {
        ...
        boolean isUserExist = customerModel.searchCustomer(Integer.parseInt(customerTel)) != null;
        if (!isUserExist) {
